...
describe TownsController do
  ...
  let(:valid_attributes) { { "town_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved town as @town" do
        ...
        post :create, {:town => { "town_name" => "invalid value" }}, valid_session
        assigns(:town).should be_a_new(Town)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested town" do
        ...
        Town.any_instance.should_receive(:update).with({ "town_name" => "MyString" })
        put :update, {:id => town.to_param, :town => { "town_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the town as @town" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Town.any_instance.stub(:save).and_return(false)
        put :update, {:id => town.to_param, :town => { "town_name" => "invalid value" }}, valid_session
        assigns(:town).should eq(town)
      end
