...
describe StreetsController do
  ...
  let(:valid_attributes) { { "street_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved street as @street" do
        ...
        post :create, {:street => { "street_name" => "invalid value" }}, valid_session
        assigns(:street).should be_a_new(Street)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested street" do
        ...
        Street.any_instance.should_receive(:update).with({ "street_name" => "MyString" })
        put :update, {:id => street.to_param, :street => { "street_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the street as @street" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Street.any_instance.stub(:save).and_return(false)
        put :update, {:id => street.to_param, :street => { "street_name" => "invalid value" }}, valid_session
        assigns(:street).should eq(street)
      end
