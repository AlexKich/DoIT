...
describe ProvidersController do
  ...
  let(:valid_attributes) { { "name_short" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved provider as @provider" do
        ...
        post :create, {:provider => { "name_short" => "invalid value" }}, valid_session
        assigns(:provider).should be_a_new(Provider)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested provider" do
        ...
        Provider.any_instance.should_receive(:update).with({ "name_short" => "MyString" })
        put :update, {:id => provider.to_param, :provider => { "name_short" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the provider as @provider" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Provider.any_instance.stub(:save).and_return(false)
        put :update, {:id => provider.to_param, :provider => { "name_short" => "invalid value" }}, valid_session
        assigns(:provider).should eq(provider)
      end
