  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved chat as @chat" do
        ...
        post :create, {:chat => { "content" => "invalid value" }}, valid_session
        assigns(:chat).should be_a_new(Chat)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested chat" do
        ...
        Chat.any_instance.should_receive(:update).with({ "content" => "MyText" })
        put :update, {:id => chat.to_param, :chat => { "content" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the chat as @chat" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Chat.any_instance.stub(:save).and_return(false)
        put :update, {:id => chat.to_param, :chat => { "content" => "invalid value" }}, valid_session
        assigns(:chat).should eq(chat)
      end
