...
describe DepartmentsController do
  ...
  let(:valid_attributes) { { "department_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved department as @department" do
        ...
        post :create, {:department => { "department_name" => "invalid value" }}, valid_session
        assigns(:department).should be_a_new(Department)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested department" do
        ...
        Department.any_instance.should_receive(:update).with({ "department_name" => "MyString" })
        put :update, {:id => department.to_param, :department => { "department_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the department as @department" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Department.any_instance.stub(:save).and_return(false)
        put :update, {:id => department.to_param, :department => { "department_name" => "invalid value" }}, valid_session
        assigns(:department).should eq(department)
      end
